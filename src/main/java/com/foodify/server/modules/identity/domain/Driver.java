...
public class Driver extends User {
    ...
    @Column(name = "cash_on_hand", precision = 19, scale = 2, nullable = false)
    private BigDecimal cashOnHand = BigDecimal.ZERO.setScale(2, RoundingMode.HALF_UP);

    @Column(name = "unpaid_earnings", precision = 19, scale = 2, nullable = false)
    private BigDecimal unpaidEarnings = BigDecimal.ZERO.setScale(2, RoundingMode.HALF_UP);

    @Column(name = "outstanding_daily_fees", precision = 19, scale = 2, nullable = false)
